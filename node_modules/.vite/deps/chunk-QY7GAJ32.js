...
var TextareaAutosize = React4.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React4.useRef(0);
  const [state, setState] = React4.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React4.useCallback(() => {
...
function useListChangeNotifiers() {
  ...
  const notifySelectionChanged = React23.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React23.useCallback((newHighlightedItem) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newHighlightedItem);
  }, [messageBus]);
  const registerSelectionChangeHandler = React23.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React23.useCallback((handler) => {
...
function useForcedRerendering() {
  const [, setState] = React27.useState({});
...
function useListItem(parameters) {
  ...
  const createHandleClick = React29.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React29.useCallback((other) => (event) => {
...
var MenuItem = React38.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
function useNumberInput(parameters) {
  ...
  const [value, setValue] = React40.useState(valueProp != null ? valueProp : defaultValueProp);
...
var _excluded14 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QY7GAJ32.js.map
